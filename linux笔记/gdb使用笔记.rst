...
格式化打印stl容器
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
:download:`gdb-stl-views <./stl-views.gdb>`

可以使用一个名为gdb-stl-views的小工具，下载完成后，将其改名为.gdbinit并放置到home目录下，然后再执行输出STL容器内容的新命令，
对于std::vector，执行pvector datas
