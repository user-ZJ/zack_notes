...
__global__ void createResizedImage(unsigned char *imageScaledData, int scaled_width, 
...
int main(int argc, char*argv[])
{
	...
	returnValue = (cudaError_t)(returnValue | cudaMemcpy( cu_array, data, height * width * sizeof(unsigned char), 
	...
	returnValue = (cudaError_t)(returnValue |cudaMemcpy (scaled_data , d_scaled_data, 
	              scaled_height*scaled_width*sizeof(unsigned char), cudaMemcpyDeviceToHost ));
	if(returnValue != cudaSuccess) 
